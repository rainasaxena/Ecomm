...
//   //if both tokens are not present then return false
//   if(!accessToken || !refreshToken){
//     return false;
//   }

//   //if token is present then send for verification
//   try{
//     console.log(accessToken)
//     const res = fetch ("http://127.0.0.1:8000/api/token/verify/",{
//       method:"POST",
//       credentials: "same-origin",
//       mode:"cors",
//       headers: {
...
//     //if res.ok then return true else fetch the refresh token 
//     if(res.ok){
//       return true;
//     } else{
